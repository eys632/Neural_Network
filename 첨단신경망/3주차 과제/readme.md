...
- **향후 개선 방안**: 필터 수를 점진적으로<img width="1189" height="490" alt="download" src="https://github.com/user-attachments/assets/c3b52f72-66bf-472b-a791-abc0fae5c569" />
 늘리거나(예: 16, 32, 64), 더 많은 에폭 동안 훈련을 진행하여 성능 향상을 기대해 볼 수 있음.
